...
router.get('/recommendations', applicationController_1.default.recommendations);
router.get('/application-warnings/pending', applicationController_1.default.getPendingWarning);
router.post('/application-warnings/:id/read', applicationController_1.default.markWarningRead);
